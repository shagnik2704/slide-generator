            ...
            <div style={modalContentStyle} onClick={e => e.stopPropagation()}>
                ...
                <div style={bodyStyle}>
                    <div className="gradient-illustration-container">
                        <MessageSquare size={36} style={{ color: 'var(--accent-primary)' }} />
                    </div>
                    <p style={{
                        color: 'var(--text-secondary)',
                        fontSize: '0.975rem',
                        ...
                        Your feedback is invaluable to us! Report bugs, request brand-new features, or share your thoughts on how we can make the generator even better.
                    </p>
                </div>
