...
def load_sample_scripts(sample_dir=None):
    if sample_dir is None:
        from pathlib import Path
        project_root = Path(__file__).parent.parent.parent
        sample_dir = project_root / "data" / "sample_scripts"
    """
...
def load_sample_scripts_as_json(sample_dir=None, max_samples=4):
    if sample_dir is None:
        from pathlib import Path
        project_root = Path(__file__).parent.parent.parent
        sample_dir = project_root / "data" / "sample_scripts" / "json"
    """
